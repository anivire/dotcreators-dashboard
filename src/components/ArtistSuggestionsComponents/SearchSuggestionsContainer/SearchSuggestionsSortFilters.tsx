...
const sortFilters = ['All', 'Suggested', 'Approved', 'Created', 'Declined'];

const sortFilterIcons: Record<string, JSX.Element> = {
  All: <></>,
  Suggested: <RiAddLine className="text-zinc-400" />,
  Approved: <RiCheckDoubleLine className="text-zinc-400" />,
  Created: <RiCheckLine className="text-zinc-400" />,
  Declined: <RiCloseLine className="text-zinc-400" />,
};

export const SearchSuggestionsSortFilters: FC<Props> = props => {
